...
x_train = np.array([xs for xs in itertools.product(range(360,1561,200), range(140,941,200))], dtype=float)
x_train = np.delete(x_train, [4, 34], 0)
x_train =  np.append(np.array([[960., 0.]]), x_train, axis=0)
x_train /= 100.

y_train = np.array([
[0, 0],
[18., 90.],[53,105],[103,125],[175,151],
[18,60],[53,70],[103,84],[177,103],[295,132],
[18,28],[35,35],[84,41],[156,51],[293,68],
[19,0],[54,0],[103,0],[176,0],[287,0],
[18,-28],[35,-35],[84,-41],[156,-51],[293,-68],
[18,-60],[53,-70],[103,-84],[177,-103],[295,-132],
[18., -90.],[53,-105],[103,-125],[175,-151]], dtype=float)
...
with open('kinect_mapping_v2.dat', "wb") as f:
