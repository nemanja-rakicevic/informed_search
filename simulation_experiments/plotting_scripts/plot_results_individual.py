...
### for new data
offset = 0
filename = _DIRNAME+'PLOTS_test_{}_kernel{}_{}_x.svg'.format(filt[0], filt[1], filt[2])

list_models = sorted([d for d in os.listdir(_DIRNAME) if all(s in d for s in filt) and d[-3:]!='svg'])
