...
# Xtrain = np.array([0, 36, 75, 120, 170, 192, 209]).reshape(-1,1)/100.
# y = np.array([0, 10, 25, 50, 100, 150, 200])/100.

# Xtest = np.linspace(0, 2.15, n).reshape(-1,1)
# Kss = kernel(Xtest, Xtest)
...
# with open('mu_cam640x480toM.dat', "wb") as f:
#     pickle.dump(np.array(zip(Xtest.ravel(), mu)), f)