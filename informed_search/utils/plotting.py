...
def plot_model_idfs(model_object, trial_num, dimensions, param_names, show_points=False):
    ...
    if len(model_object.mu_alpha):
        ...
        plt.savefig(model_object.dirname+"/img_training_trial#{num:03d}_angle.png".format(num=trial_num), format="png")
        ...
        plt.savefig(model_object.dirname+"/img_training_trial#{num:03d}_dist.png".format(num=trial_num), format="png")
        ...
        plt.savefig(model_object.dirname+"/img_training_trial#{num:03d}_select.png".format(num=trial_num), format="png")
        ...
        #     plt.savefig(model_object.dirname+"/img_training_trial_{}.png".format(trial_num), format="png")
        # else:
        #     plt.savefig(model_object.dirname+"/img_training_trial#{num:03d}.png".format(num=trial_num), format="png")
...
def plot_model(model_object, trial_num, dimensions, param_names, show_points=False):
    # if trial_num%1==0 or trial_info.fail_status==0:
    # print "<- CHECK PLOTS"     
