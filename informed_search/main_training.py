...
parser.add_argument('-e', '--environment', default='sim5link', 
                    help="Select which environment to use: "
                         ...
                         "'robot'")
# Modelling
parser.add_argument('-m', '--search_type', default='UIDF', 
...
parser.add_argument('-pcov', '--pidf_cov', default=0.1, 
                    type=float,  
                    help="Penalisation function covariance coefficient.")

parser.add_argument('-kname', '--kernel_name', default='se',      
                    help="Gaussian Process Regression kernel function.")

parser.add_argument('-kls', '--kernel_lenscale', default=0.01,      
                    type=float,
                    help="Sigma coefficient of the kernel")

parser.add_argument('-ksig', '--kernel_sigma', default=1.,      
                    type=float, 
                    help="Sigma coefficient of the kernel")
